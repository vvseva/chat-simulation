...
class RealtimeApp(App[None]):
    ...
    async def handle_realtime_connection(self) -> None:
        async with self.client.beta.realtime.connect(model="gpt-4o-realtime-preview-2024-10-01") as conn:
            ...
            # Updated to include the system prompt
            await conn.conversation.item.create(
                item={
                    "type": "message",
                    "role": "system",
                    "content": [{"type": "input_text", "text": "Your Name is Sage. You are an expert in space exploration. And the best lending location is Eridania."}],
                }
            )
    ...
    async def send_mic_audio(self) -> None:
        ...
        # Find the index of your microphone from the output
        # For example, let's say your microphone is at index 2:
        mic_index = 1
        ...
        stream = sd.InputStream(
            ...
            dtype="int16",
            device=mic_index  # Specify the device index here
        )
        stream.start()
